<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-navy-800">Survey VMTS Teknik Informatika Configuration</h1>
                <p class="text-navy-600 mt-2">Kelola survey pengukuran pemahaman VMTS Teknik Informatika</p>
            </div>
