...
class MahasiswaForm extends Component
{
    ...
    public $surveyType;
    public $title = 'Survei Pengukuran Pemahaman Mahasiswa Fakultas Ilmu Komputer';
    public $description = '';
    ...
    {
        $this->loadSections();
        $this->loadMahasiswaSurvey();
    }

    public function loadSections()
    {
        $surveyType = SurveyTypes::where('name', 'MAHASISWA')->first();
        if ($surveyType) {
    ...
    public function loadMahasiswaSurvey()
    {
        $this->surveyType = SurveyTypes::where('name', 'MAHASISWA')
    ...
    public function saveAllData()
    {
        ...
        try {
            ...
            $this->dispatch(
                'notify',
                type: 'success',
                message: 'Survey Mahasiswa berhasil disimpan!'
            );
        } catch (\Exception $e) {
            $this->dispatch(
                'notify',
    ...
    {
        return view('livewire.dashboard.survey.mahasiswa-form');
    }
}
