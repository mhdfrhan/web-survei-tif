...
class TifForm extends Component
{
    // Survey Type Properties
    public $surveyType;
    public $title = 'Survei Pengukuran Pemahaman VMTS Program Studi Teknik Informatika';
    public $description = '';
    ...
    public function loadVmtsTifSurvey()
    {
        $this->surveyType = SurveyTypes::where('name', 'VMTSTIF')
    ...
    public function saveAllData()
    {
        ...
        try {
            ...
            $this->dispatch(
                'notify',
                type: 'success',
                message: 'Survey VMTS TIF berhasil disimpan!'
            );
        } catch (\Exception $e) {
            $this->dispatch(
                'notify',
    ...
    {
        return view('livewire.dashboard.survey.tif-form');
    }
}
