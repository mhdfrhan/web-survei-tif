...
class SurveyResponseDosenSeeder extends Seeder
{
    public function run()
    {
        // Hapus data lama
        DB::table('survey_responses')->where('survey_type_id', 2)->delete();

        // Ambil semua pertanyaan tipe 'rating' untuk survey_type_id = 2
